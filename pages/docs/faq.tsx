  ...
  return (
    <DocLayout pageTitle="FAQ" description="Find answers to some frequently asked questions here.">
      ...
      <section id="snippet-1" className="wrapper py-16">
        ...
        <a href="#" className="btn btn-primary rounded-pill me-2" target="_blank" rel="noreferrer">
          Contact Form
        </a>

        <a href="#" className="btn btn-soft-primary rounded-pill" target="_blank" rel="noreferrer">
          Discussions Page
        </a>
