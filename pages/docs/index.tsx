...
const quickAccess = [
  ...
  { title: 'Quick Video', url: 'snippet-4' }
];
...
const Documentation: NextPage = () => {
  return (
    ...
    >
      ...
      {/* ========== section 3 ========== */}
      <section id="snippet-3" className="wrapper pt-16 mb-5">
      ...
      {/* <section id="snippet-4" className="wrapper py-16">
        <h2 className="mb-5">Quick Installation Video</h2>
        <div className="card">
          <div className="card-body">
            <p className="mb-2">
              This{' '}
            ...
            <ul className="unordered-list mb-0">
              <li>
                Installing npm packages (Terminal command: <kbd className="terminal mt-n1">npm install</kbd>)
              </li>
